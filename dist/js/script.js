document.addEventListener("DOMContentLoaded", () => {
  ...
  const createTask = (taskText, isChecked = false) => {
    ...
    taskItem.className =
      "relative w-full mb-2 bg-slate-200 text-dark p-3 rounded-md flex items-center";
    ...
    buttonContainer.className = "absolute right-2 top-1/2 transform -translate-y-1/2 flex"; 
    ...
    // Menambahkan ikon ke dalam container tombol
    ...
    // Tambahkan taskItem ke todoListContainer
